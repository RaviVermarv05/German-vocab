...
chapter_eight = {
    ("to strain", "to exert"): ["anstrengen (sich)", "sich bemühen", "beanspruchen"],
    ...
    ("raw",): ["roh"],
    ("to snore",): ["schnarchen"],
    ("to strengthen", "to reinforce"): ["stärken", "kräftigen"],
    ("steak",): ["das Steak"],
    ("to sting",): ["stechen"],
    ("to chase away",): ["verjagen", "vertreiben"],
    ("to swallow",): ["verschlucken", "schlucken"],
    ("evaluation",): ["die Auswertung", "die Einschätzung"],
    ("to assess",): ["einschätzen", "bewerten"],
    ...
    ("to damage", "to harm"): ["schaden"],
    ("to beat", "to hit"): ["schlagen", "hauen"],
    ("pain",): ["die Schmerzen"],
