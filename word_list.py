...
chapter_nine = {
    ...
    ("female cleaner"): ["die Putzfrau", "die Reinigungskraft"],
    ...
    ("guilty", "guiltily"): ["schuldig", "verantwortlich"],
    ...
    ("example sentence",):["der Beispielsatz", "der Beispielsatz"],
    ...
    ("outright", "pure(ly)"):["rein", "pur", "ganz"],
